...
from RobustOptimization.two_stage_robust_optimization_sparse import TwoStageRobustOptimization as RO
...
class UnitCommitment():
    ...
    def stochastic_optimization(self, mg, ns=40):
        ...
        sol = ro.main(model_first_stage["c"], Aeq=model_first_stage["Aeq"].toarray(), beq=model_first_stage["beq"],
                      ...
                      u_delta=u_delta.reshape((self.nv_uncertainty, 1)), budget=array([[u_delta.shape[0]*0.2]]),)
        sol = sol[:, 0]
...
if __name__ == "__main__":
    ...
    unit_commitment.stochastic_optimization(mg=mg)
