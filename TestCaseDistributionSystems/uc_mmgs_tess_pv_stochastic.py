...
from TestCaseDistributionSystems.test_cases import case33
...
from TestCaseDistributionSystems.data_format.idx_MG_PV import PBIC_AC2DC, PG, PESS_DC, PBIC_DC2AC, PUG, PESS_CH, \
    PMESS, EESS, NX_MG, QBIC, QUG, QG, PPV

from TestCaseDistributionSystems.database_management_pv import DataBaseManagement
...
class StochasticDynamicOptimalPowerFlowTess():
    ...
    def main(self, power_networks, micro_grids, profile, pv_profile, mess, traffic_networks, ns=100):
        ...
        model_first_stage = self.first_stage_problem_formulation(pns=power_networks, mgs=micro_grids, mess=mess,
    ...
    def first_stage_problem_formulation(self, pns, mgs, mess, tns):
        """
    ...
    def problem_formulation_tess(self, mess, tns):
        ...
        ux[nl_tra + 0 * n_stops:nl_tra + 1 * n_stops] = 1 # The locations
